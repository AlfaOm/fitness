...
const showCardCoaches = () => {
  coachesSlide.forEach(function (tab, i) {
    tab.addEventListener("click", function () {
      ...
      //   });
      // }
      if (windowInnerWidth <= 1199 && getComputedStyle(coachesCardInfo[i]).display === "none") {
        coachesCardInfo[i].style.display = "block";
        headingSlide.forEach(el => {
          el.style.bottom = "";
          el.style.top = "52px";
...
function setupVideo(video) {
  let link = video.querySelector(".video__link"); // let media = video.querySelector(".video__media");
