...
/* harmony import */ var _modules_toggle_tab__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/toggle-tab */ "./js/modules/toggle-tab.js");
/* harmony import */ var _modules_coaches_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/coaches-swiper */ "./js/modules/coaches-swiper.js");
/* harmony import */ var _modules_switch_reviews__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/switch-reviews */ "./js/modules/switch-reviews.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form */ "./js/modules/form.js");
/* harmony import */ var _modules_show_card_coaches__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/show-card-coaches */ "./js/modules/show-card-coaches.js");
...
window.addEventListener("DOMContentLoaded", () => {
  window.addEventListener("load", () => {
    ...
    Object(_modules_toggle_tab__WEBPACK_IMPORTED_MODULE_1__["toggleTab"])();
    Object(_modules_coaches_swiper__WEBPACK_IMPORTED_MODULE_2__["switchSwiper"])();
    Object(_modules_switch_reviews__WEBPACK_IMPORTED_MODULE_3__["switchSwiperReviews"])();
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_4__["validateInput"])();
    Object(_modules_show_card_coaches__WEBPACK_IMPORTED_MODULE_5__["showCardCoaches"])();
  });
});

/***/ }),

/***/ "./js/modules/coaches-swiper.js":
/*!**************************************!*\
  !*** ./js/modules/coaches-swiper.js ***!
  \**************************************/
...
const validateInput = () => {
  ...
  inputPhone.addEventListener("input", () => {
    ...
    if (valueLength < MAX_LENGTH_INPUT_TEL) {
      inputPhone.setCustomValidity("Введите номер в формате: +7 (123) 456 7890");
    } else {
...
function myCoolFunction() {
  ...
  if (windowInnerWidth < DESKTOP_WIDTH) {
    if (windowInnerWidth <= TAB_WIDTH && !coachesCardInfo[i].classList.contains("coaches__card-info--tab-show")) {
      coachesCardInfo[i].classList.add("coaches__card-info--tab-show");
      headingSlide[i].style.display = "none"; // headingSlide[i].style.bottom = "";
      ...
      // }
    } else if (windowInnerWidth < DESKTOP_WIDTH && coachesCardInfo[i].classList.contains("coaches__card-info--tab-show")) {
      coachesCardInfo[i].classList.remove("coaches__card-info--tab-show");
      headingSlide[i].style.display = "block"; // headingSlide[i].style.top = "";
...
/***/ "./js/modules/switch-reviews.js":
/*!**************************************!*\
  !*** ./js/modules/switch-reviews.js ***!
  \**************************************/
/*! exports provided: switchSwiperReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
